...
for seq in westerndesert #hospital #abandonedfactory_night
do
...
#gdb -ex run --args \
./build/bin/cvo_covis_tartan /home/rayzhang/media/Samsung_T5/tartanair/$seq/Easy/P002/  cvo_params/cvo_outdoor_params.yaml /home/rayzhang/dsm/tartan_Easy_${seq}/${1}_graph.txt 1 /home/rayzhang/dsm/tartan_Easy_${seq}/ covisMap${1}.pcd 
