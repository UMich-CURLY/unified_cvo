...
for seq in soulcity #westerndesert #hospital #abandonedfactory_night
do
...
#./build/bin/cvo_irls_tartan /home/rayzhang/media/Samsung_T5/tartanair/$seq/Easy/P002/  cvo_params/cvo_outdoor_params.yaml /home/rayzhang/dsm/tartan_Easy_${seq}/${1}_graph.txt 1 /home/rayzhang/dsm/tartan_Easy_${seq}/ #covisMap${1}.pcd 
#gdb -ex run --args \
./build/bin/cvo_covis_tartan /home/rayzhang/media/Samsung_T5/tartanair/$seq/Easy/P001/  cvo_params/cvo_outdoor_params.yaml /home/rayzhang/dsm/tartan_Easy_${seq}/${1}_graph.txt 1 /home/rayzhang/dsm/tartan_Easy_${seq}/ covisMap${1}.pcd 
