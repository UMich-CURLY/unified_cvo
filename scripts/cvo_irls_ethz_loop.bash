...
clear
    ...
    seqs=(  gazebo_summer gazebo_winter  )
    for ind in ${!seqs[@]}
    do
        i=${seqs[ind]}
        echo " Current Seq: ${i}"        
        #sky=${skylabel[ind]}
	folder=ethz_${dtype}_${i}_${date}
	#track_folder=/home/rzh/slam_eval/result_floam/${i}/
	#track_folder=/home/rzh/slam_eval/result_floam/${i}/
        dataset_folder=/home/`whoami`/media/Samsung_T5/ethz/${i}/
	#dataset_folder=/home/rzh//media/sdg1/rzh/kitti_lidar/kitti_${dtype}/dataset/sequences/${i}/
        lc_file=/home/`whoami`/media/Samsung_T5/ethz/${i}/loop_closures.txt
        #lc_file=/home/rayzhang/unified_cvo/demo_data/kitti_loop_closure/kitti_${i}_loop_closure.g2o

	rm -rf $folder
	mkdir -p $folder
	cp results/cvo_geometric_ethz_sep27/${i}.txt $folder/tracking_full.txt        
	...
	rm *.pcd
        ...
        #gdb  -ex    run --args \
        ./build/bin/cvo_irls_lidar_loop ${dtype} $dataset_folder cvo_params/cvo_irls_ethz_ba_params.yaml 1 $folder/tracking_full.txt $lc_file  ba.txt 1 0 1000000 2.0 0.2  0 1 0  #> log_kitti_loop_${i}.txt
