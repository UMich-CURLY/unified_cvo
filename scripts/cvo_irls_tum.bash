...
#gdb -ex run --args \
./build/bin/cvo_irls_tum /home/rayzhang/media/Samsung_T5/tum/freiburg1_${seq} cvo_params/cvo_intensity_params_irls_tum.yaml /home/rayzhang/dsm/tum_fr1_${seq}/${frame}_graph.txt 1 /home/rayzhang/dsm/tum_fr1_${seq}/ #covisMap${frame}.pcd 
echo "Evaluation: "
echo "before BA ate:"
