...
cd ..
#gdb -ex run --args \
./build/bin/cvo_irls_tum /home/rayzhang/media/Samsung_T5/tum/freiburg1_desk2 cvo_params/cvo_intensity_params_irls_tum.yaml graph_defs/tum/19_graph.txt /home/rayzhang/media/Samsung_T5/tum/freiburg1_desk2/CVO.txt  
echo "Evaluation: "
echo "before BA ate:"
