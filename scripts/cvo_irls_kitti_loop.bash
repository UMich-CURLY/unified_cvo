...
clear
	...
	rm *.pcd
        ...
        #gdb -ex run --args \
        ./build/bin/cvo_irls_lidar_loop $dataset_folder cvo_params/cvo_irls_kitti_ba_params.yaml 2 $folder/tracking_full.txt $lc_file  ba.txt 0 0 1000000 0.5 0 1 0 # > log_tartan_rgbd_${difficulty}_${i}.txt
        #./build/bin/cvo_irls_lidar_loop $dataset_folder cvo_params/cvo_irls_kitti_ba_params.yaml 3 $folder/tracking_full.txt $lc_file  ba.txt 0 0 1000000 4.0 0 0 # > log_tartan_rgbd_${difficulty}_${i}.txt
        mv *.pcd $folder/
