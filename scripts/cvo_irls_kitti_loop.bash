...
clear
	...
	dataset_folder=/home/rzh//media/sdg1/rzh/kitti_lidar/kitti_lidar/dataset/sequences/${i}/
        lc_file=/home/rzh/unified_cvo/demo_data/kitti_loop_closure/kitti_${i}_loop_closure.g2o
	...
	rm *.pcd
        ...
        #gdb -ex run --args \
        ./build/bin/cvo_irls_lidar_loop $dataset_folder cvo_params/cvo_irls_kitti_ba_params.yaml 2 $folder/tracking_full.txt $lc_file  ba.txt 0 0 1000000 2.0 0.2  10 0 1  #> log_kitti_loop_${i}.txt
