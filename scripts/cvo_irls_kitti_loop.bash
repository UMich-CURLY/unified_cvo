...
clear
	...
	rm *.pcd
        ...
        #gdb -ex run --args \
        ./build/bin/cvo_irls_lidar_loop $dataset_folder cvo_params/cvo_irls_kitti_ba_params.yaml 2 $folder/tracking_full.txt $lc_file  ba.txt 0 0 1000000 0.5 0 1 1  > log_kitti_loop_${i}.txt
        mv *.pcd $folder/
