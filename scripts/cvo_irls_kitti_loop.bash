...
clear
	...
	rm *.pcd
        ...
        ### run global BA
        #gdb -ex run --args \
        ./build/bin/cvo_irls_lidar_loop $dataset_folder cvo_params/cvo_irls_kitti_ba_params.yaml 2 $folder/tracking_full.txt $lc_file  ba.txt 0 0 1000000 2.0 0 0 # > log_tartan_rgbd_${difficulty}_${i}.txt
        mv *.pcd $folder/
