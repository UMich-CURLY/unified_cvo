...
clear
    ...
    do
        ...
        echo " Current Seq: ${i}"        
        #sky=${skylabel[ind]}
	folder=kitti_${dtype}_${i}_${date}
	#track_folder=/home/rzh/slam_eval/result_floam/${i}/
	#track_folder=/home/rzh/slam_eval/result_floam/${i}/
        dataset_folder=/home/`whoami`/media/Samsung_T5/kitti_${dtype}/dataset/sequences/${i}/
	...
	rm *.pcd
        ...
        #gdb  -ex    run --args \
        ./build/bin/cvo_irls_lidar_loop ${dtype} $dataset_folder cvo_params/cvo_irls_kitti_ba_params.yaml 2 $folder/tracking_full.txt $lc_file  ba.txt 0 0 1000000 2.0 0.2  5 0 0  #> log_kitti_loop_${i}.txt
