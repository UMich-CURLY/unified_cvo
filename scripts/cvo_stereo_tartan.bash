...
for i in abandonedfactory_night endofworld carwelding amusement gascola hospital japanesealley neighborhood ocean office oldtown seasidetown seasonsforest seasonsforest_winter soulcity westerndesert
do
	echo "new seq $i"
      ./build/bin/main_cvo_gpu_align_stereo_tartan /media/sdc1/rzh/tartanair/$i/Easy/P001 cvo_params/cvo_outdoor_params.yaml \
                                       tartan_results/cvo_tartan_outdoor_$i.txt 0 30000
#      python scripts/xyzq2kitti.py tartan_results/cvo_tartan_outdoor_$i.txt results/tartan/kitti_$i.txt
