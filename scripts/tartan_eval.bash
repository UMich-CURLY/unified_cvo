...
#                                       cvo_tartan_outdoor_${i}_${start_ind}_${end_ind}.txt ${start_ind} ${end_ind}
      ...
      python scripts/xyzq2kitti.py /run/media/rayzhang/Samsung_T5/tartanair/$i/Easy/P001/pose_left.txt results/tartan/gt_outdoor_easy_kitti_${i}_${start_ind}_${end_ind}.txt ${start_ind} ${end_ind}
      python ~/.local/lib/python3.10/site-packages/evo/main_traj.py kitti --ref results/tartan/gt_outdoor_easy_kitti_${i}_${start_ind}_${end_ind}.txt  results/tartan/outdoor_easy_kitti_${i}_${start_ind}_${end_ind}.txt   --plot_mode xyz --align --save_plot results/tartan/${i}_plot -p 
done
...
#      python scripts/xyzq2kitti.py cvo_tartan_outdoor_${i}.txt results/tartan/outdoor_easy_kitti_${i}.txt
      #python scripts/xyzq2kitti.py /run/media/rayzhang/Samsung_T5/tartanair/$i/Easy/P001/pose_left.txt results/tartan/gt_outdoor_easy_kitti_${i}.txt 
#      python ~/.local/lib/python3.10/site-packages/evo/main_traj.py kitti --ref results/tartan/gt_outdoor_easy_kitti_${i}.txt  results/tartan/outdoor_easy_kitti_${i}.txt   --plot_mode xyz --align --save_plot results/tartan/${i}_plot -p 
#done
