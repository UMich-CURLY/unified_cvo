...
for i in 03 #00 01 02 03 05 06 07 08 09 10 #01 02 03 04 05 06 07 08 09 10
...
do
    echo ""
    echo "/********************** Sequence "$i" *************************/"
    for method in ground_truth gicp ndt mc_icp  #cvo_img_semantic_oct26_best #fast_gicp #results_semantic_cvo #results_gicp_new results_ndt ground_truth results_cvo_geometric_stereo #results_gicp results_color_cvo 
    do
