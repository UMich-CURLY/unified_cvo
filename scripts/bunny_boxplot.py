    ...
    for angle in angles_defined:
        ...
        for crop in crop_defined:
            ...
            for outlier in outlier_defined:
                ...
                ax[i].set_xticks([])
                ax[i].set_xlabel(x_axis_label[i])#,weight='bold')
                ...
                if (i == 0):
                    ...
                    ax[i].legend(handles=bp['boxes'], labels=legend_list,  bbox_to_anchor=(4.05, 1.31), ncol=2,prop={'size': 12.5})
            ...
            fig.text(0.55, 0.01, 'Outlier Ratio (%)', ha ='center',fontsize = fontsize)
...
if __name__ == '__main__':
    ...
    method_list = ['cvo', 'cvo_local', 'fgr', 'fpfh' ]
    legend_list = [
        'RKHS Global',
        'CVO',
        'FGR',
    ...
    x_axis_label = ['0.0', '0.125', '0.25', '0.375', '0.5']
    crop_defined = [0.0, 0.125, 0.25, 0.375, 0.5]
    colors = [[173/255, 216/255, 230/255], #blue
              [1.0, 0.75, 0.0],            #amber
              [144/255, 238/255, 144/255], #green
              [181/255, 101/255, 29/255]   #purple
              ]
