...
for i in eth3d_sfm_lab_room_1/ #westerndesert  #hospital  #abandonedfactory_night #neighborhood  #seasidetown abandonedfactory  seasonsforest gascola hospital
do
    
	#./build/bin/stack_pcd_viewer /home/rayzhang/kitti_color_05 2700 0 0
   ./build/bin/stack_pcd_viewer /home/rayzhang/unified_cvo/$i 260 0 0
