...
for i in hospital #abandonedfactory #tum_freiburg1_desk2 tum_freiburg1_room
do
   folder=/home/rayzhang/slam_eval/tartan_semantic_Easy_${i}_${date} 
   #folder=/home/rayzhang/dsm/
   #gdb -ex run --args \
 ./build/bin/stack_pcd_viewer $folder 2000 0 1 tartan $folder/rkhs_slam.txt
