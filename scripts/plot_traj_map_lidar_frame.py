...
def visualize_traj(pcd_dir,
    ...
    for i in range( num_frames):
        ...
        #new_extrinsic[2, 3] = track_pose[1, 3]
...
if __name__ == '__main__':
    ...
    pcd_folder = "kitti_lidar_pcd_lidar_frame_downsample_05/" #s#ys.argv[1] ## Lidar Frame
    track_pose_file = "kitti_lidar_05_jan23/tracking.txt" #"lidar_05_cvo_odom_old.txt" #"results/cvo_intensity_lidar_jun09/05.txt" #sys.argv[2]
    ba_file = "kitti_lidar_05_jan23/ba.txt" #"lidar_ba_05.txt" #"kitti_lidar_05_oct15_mulls/ba.txt"
