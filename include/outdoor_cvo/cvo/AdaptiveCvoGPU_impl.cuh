...
namespace cvo {
  ...
  void update_tf(const Mat33f & R, const Vec3f & T,
     ...
     */
  void compute_flow(CvoState * cvo_state, const CvoParams * params_gpu, bool is_ell_adaptive );

  void compute_step_size(CvoState * cvo_state, const CvoParams * params_cpu, bool is_ell_adaptive);
